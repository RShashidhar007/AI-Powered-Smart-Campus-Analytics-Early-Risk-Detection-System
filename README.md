...
* **🗄️ Robust SQLite Persistence:** Powered by a unified SQLite database for better data integrity, rapid indexing, and continuous historical student tracking.
...
* **📊 Interactive Dashboards:** Dynamic visualizations using `Plotly`, featuring correlation heatmaps, risk distribution funnels, and predictive clustering.
...
* **Database & Persistence:** SQLite (SQLAlchemy / sqlite3)
...
*(Note: You can configure and register additional platform users dynamically via the built-in Registration interface.)*
